...
'''
    Following file is responsible for implementing the website located at the following URL:
        https://jberpme-96ea7d14ff9b.herokuapp.com/
    All required installations are found in requirements.txt.
    To deploy the app on the Heroku platform, requirements.txt and Procfile need to be present in the same folder as app.py.
